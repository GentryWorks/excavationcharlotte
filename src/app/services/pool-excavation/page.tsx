...
import serviceImg from "@/assets/pool-excavation-charlotte.webp";
import poolSectionImg from "@/assets/pool-excavation-section-charlotte.webp";
import poolHeroImg from "@/assets/pool-excavation-hero-charlotte.webp";
...
const faqSchema = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "How much does pool excavation cost in Charlotte?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Pool excavation cost in Charlotte depends on pool size, depth, soil conditions, and site access. Charlotte-area soil is often clay-heavy, which slows digging and affects haul-off volume. We give you a written estimate after a site visit — no guessing, no surprises after the job starts.",
      },
    },
    {
      "@type": "Question",
      name: "How much does pool removal cost in Charlotte?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Pool demolition and removal in Charlotte typically costs more than new pool excavation because it involves breaking up concrete or fiberglass, separating rebar, hauling off debris, backfilling, and compacting in lifts. Partial demolition (punching holes and abandoning the shell) costs less than full removal. We quote both options so you can decide what makes sense for your situation.",
      },
    },
    {
      "@type": "Question",
...
const faqs = [
  {
    q: "How much does pool excavation cost in Charlotte?",
    a: "Pool excavation cost in Charlotte depends on pool size, depth, soil conditions, and site access. Charlotte-area soil is often clay-heavy, which slows digging and affects haul-off volume. We give you a written estimate after a site visit — no guessing, no surprises after the job starts.",
  },
  {
    q: "How much does pool removal cost in Charlotte?",
    a: "Pool demolition and removal in Charlotte typically costs more than new pool excavation because it involves breaking up concrete or fiberglass, separating rebar, hauling off debris, backfilling, and compacting in lifts. Partial demolition (punching holes and abandoning the shell) costs less than full removal. We quote both options so you can decide what makes sense for your situation.",
  },
  {
  ...
  return (
    <>
      ...
      <section className="relative py-28 md:py-40">
        <Image
          src={poolHeroImg}
          alt="Pool excavation project in Charlotte"
          fill
          fetchPriority="high"
          loading="eager"
        ...
        <div className="relative max-w-[1200px] mx-auto px-6 text-center">
          ...
          <p className="text-white opacity-90 text-lg max-w-2xl mb-10 leading-relaxed mx-auto">
            Whether you&apos;re installing a new pool or removing an old one, trust Excavation Charlotte Co. for expert pool excavation, demolition, and backfill services across Charlotte and surrounding areas.
          </p>
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="flex-1">
              <h2 className="text-2xl md:text-3xl font-extrabold mb-4" style={{ color: "#1B2A4A" }}>
                Complete Pool Excavation, Removal, and Demo in the <span style={{ color: "#C4883A" }}>Greater Charlotte Area</span>
              </h2>
              <p className="text-base leading-relaxed" style={{ color: "#2D2D2D" }}>
                Pool excavation in Charlotte is more involved than it looks. Northeast North Carolina's clay soil affects how fast a pool can be dug, how much material needs to be hauled, and how backfill settles after pool removal. We handle both sides of the job — digging new inground pools to your builder&apos;s exact specs and demolishing old pools with proper backfill and compaction. Residential homeowners, pool builders, and general contractors across the Greater Charlotte area count on us to show up on time and do the work right.
              </p>
            </div>
            <div className="flex-1">
              <div className="relative w-full rounded-xl overflow-hidden" style={{ aspectRatio: "4/3" }}>
                <Image src={poolSectionImg} alt="Pool excavation project in Charlotte" fill loading="lazy" style={{ objectFit: "cover", objectPosition: "center" }} />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            <div>
              <h2 className="text-2xl md:text-3xl font-extrabold mb-6" style={{ color: "#1B2A4A" }}>
                Why Choose Excavation Charlotte Co. for Your <span style={{ color: "#C4883A" }}>Pool Project?</span>
              </h2>
              <ul className="space-y-4">
                {[
                  "Experienced with Charlotte-area clay soil and its impact on pool digs",
      ...
      <section className="py-20" style={{ backgroundColor: "#F5F5F5" }}>
        <div className="max-w-[1200px] mx-auto px-6 text-center">
          ...
          <p className="text-base mb-8 max-w-xl mx-auto" style={{ color: "#2D2D2D", opacity: 0.7 }}>
            We handle pool excavation and pool removal across Charlotte and surrounding areas.
          </p>
