...
import serviceImg from "@/assets/residential-demolition-charlotte.webp";
...
import cardGravel from "@/assets/card-gravel-driveway-charlotte.webp";
...
const faqSchema = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "How much does house demolition cost in Charlotte?",
      acceptedAnswer: {
        "@type": "Answer",
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "All utilities must be disconnected and confirmed before any demo work starts. We coordinate directly with North Carolina Edison, Charlotte Water, and telecom providers to schedule and verify each disconnect. We do not begin demolition until every utility is confirmed off.",
      },
    },
    {
      "@type": "Question",
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "North Carolina law requires asbestos and lead paint assessments before demolishing structures built before 1980. We refer clients to licensed environmental consultants for testing and abatement. We do not proceed with demo until hazardous materials have been properly cleared and documented.",
      },
    },
    {
      "@type": "Question",
      name: "How long does it take to demolish a house in Charlotte?",
      acceptedAnswer: {
        "@type": "Answer",
...
const faqs = [
  {
    q: "How much does house demolition cost in Charlotte?",
  ...
  },
  {
    ...
    a: "All utilities must be disconnected and confirmed before any demo work starts. We coordinate directly with North Carolina Edison, Charlotte Water, and telecom providers to schedule and verify each disconnect. We do not begin demolition until every utility is confirmed off.",
  },
  {
    q: "Do you check for asbestos before demolishing a house?",
    a: "North Carolina law requires asbestos and lead paint assessments before demolishing structures built before 1980. We refer clients to licensed environmental consultants for testing and abatement. We do not proceed with demo until hazardous materials have been properly cleared and documented.",
  },
  {
    q: "How long does it take to demolish a house in Charlotte?",
      ...
      <section className="relative py-28 md:py-40">
        ...
        <div className="relative max-w-[1200px] mx-auto px-6 text-center">
          ...
          <p className="text-white opacity-80 text-lg max-w-2xl mb-10 leading-relaxed mx-auto">
            Permitted house demolition, garage teardowns, and interior demo for residential renovation projects across Charlotte and surrounding areas. We handle permits, utility disconnects, hazardous material referrals, and site cleanup.
          </p>
      ...
      <section className="py-20" style={{ backgroundColor: "#ffffff" }}>
        <div className="max-w-[800px] mx-auto px-6">
          <h2 className="text-2xl md:text-3xl font-extrabold mb-6" style={{ color: "#1B2A4A" }}>
            Cleared Space for Bright Futures: Home Demolition in <span style={{ color: "#C4883A" }}>Greater Charlotte</span>
          </h2>
          <p className="text-sm leading-relaxed mb-6" style={{ color: "#2D2D2D", opacity: 0.85 }}>
            Tearing down a structure can feel like a massive undertaking, but it&apos;s often the very first step toward building something new. Whether you&apos;re a homeowner ready to clear space for your dream custom build or a developer prepping a lot for new construction, Excavation Charlotte Co. handles the heavy lifting safely, legally, and efficiently.
          </p>
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold mb-6 mt-10" style={{ color: "#1B2A4A" }}>
            Why Choose Excavation <span style={{ color: "#C4883A" }}>Charlotte Co.?</span>
          </h2>
          <div className="space-y-4 mb-6">
            <div>
              ...
              <p className="text-sm leading-relaxed" style={{ color: "#2D2D2D", opacity: 0.85 }}>
                You shouldn&apos;t have to spend your mornings deciphering local permit laws or waiting in line at municipal offices. We manage the entire permitting process, ensuring your project is compliant with local codes across Charlotte and surrounding municipalities.
              </p>
            </div>
            <div>
              <p className="text-sm font-bold mb-1" style={{ color: "#1B2A4A" }}>Responsible Cleanup and Disposal</p>
              <p className="text-sm leading-relaxed" style={{ color: "#2D2D2D", opacity: 0.85 }}>
                We care about the Charlotte community, which means we care about responsible disposal. We don&apos;t just throw everything into a dump truck — we sort materials on-site to recycle concrete, wood, and metals whenever possible.
              </p>
            </div>
            <div>
      ...
      <section className="py-20" style={{ backgroundColor: "#ffffff" }}>
        <div className="max-w-[1200px] mx-auto px-6 text-center">
          ...
          <p className="text-base mb-8 max-w-xl mx-auto" style={{ color: "#2D2D2D", opacity: 0.7 }}>
            We provide residential demolition services across Charlotte and surrounding areas.
          </p>
