...
import serviceImg from "@/assets/land-clearing-excavator-charlotte.webp";
import sectionImg from "@/assets/land-clearing-section-charlotte.webp";
...
const serviceSchema = {
  ...
  name: "Land Clearing",
  description:
    `Tree removal, brush and shrub clearing, stump grinding, root ball removal, and debris hauling for residential and commercial sites across ${siteConfig.city} and Northeast North Carolina.`,
  provider: {
    "@type": "LocalBusiness",
...
const faqSchema = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "How much does land clearing cost in Charlotte?",
      acceptedAnswer: {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      name: "How long does it take to clear a residential lot in Charlotte?",
      acceptedAnswer: {
        "@type": "Answer",
...
const faqs = [
  {
    q: "How much does land clearing cost in Charlotte?",
  ...
  {
    q: "How long does it take to clear a residential lot in Charlotte?",
  ...
  {
    q: "Do I need a permit to clear trees in Charlotte?",
    a: "Permit requirements vary by municipality. Some Charlotte-area jurisdictions require tree removal permits or tree preservation plans depending on tree size and species. Parma, Lakewood, and Strongsville each have their own tree ordinances. We flag any known requirements for your area during the estimate.",
  },
];
    ...
    <>
      ...
      <section className="relative py-28 md:py-40">
        ...
        <div className="relative max-w-[1200px] mx-auto px-6 text-center">
          ...
          <p className="text-white opacity-80 text-lg max-w-2xl mb-10 leading-relaxed mx-auto">
            Tree removal, brush clearing, stump grinding, and full debris hauling for residential and commercial sites. We handle land clearing in Charlotte and across Northeast North Carolina — from single building lots to multi-acre development sites.
          </p>
      ...
      <section className="py-20" style={{ backgroundColor: "#ffffff" }}>
        <div className="max-w-[800px] mx-auto px-6">
          <div className="flex flex-col md:flex-row gap-12 items-center">
            ...
            <div className="flex-1">
              <div className="relative w-full rounded-xl overflow-hidden" style={{ aspectRatio: "4/3" }}>
                <Image src={sectionImg} alt="Land clearing project in Charlotte" fill loading="lazy" style={{ objectFit: "cover", objectPosition: "center" }} />
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3 mb-6">
            {[
              { title: "Versatile Solutions", desc: "We work on properties of all sizes, from urban lots to rural tracts of land across Northeast North Carolina." },
      ...
      <section className="py-20" style={{ backgroundColor: "#ffffff" }}>
        <div className="max-w-[1200px] mx-auto px-6 text-center">
          ...
          <p className="text-base mb-8 max-w-xl mx-auto" style={{ color: "#2D2D2D", opacity: 0.7 }}>
            We provide land clearing services across Charlotte and surrounding areas.
          </p>
