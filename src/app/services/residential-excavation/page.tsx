...
import serviceImg from "@/assets/residential-excavation-charlotte.webp";
import sectionImg from "@/assets/residential-excavation-section-charlotte.webp";
...
const faqSchema = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "How much does residential excavation cost in Charlotte?",
      acceptedAnswer: {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      name: "How long does foundation excavation take for a new home in Charlotte?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "A standard residential foundation dig in the Charlotte area typically takes one to three days. The timeline depends on the size of the footprint, required depth, and how much clay or hardpan we encounter. Charlotte soils vary widely — some lots dig fast, others take longer. We give you a specific timeline with every written estimate.",
      },
    },
    {
      "@type": "Question",
      name: "Do I need a permit for residential excavation in Charlotte?",
      acceptedAnswer: {
        "@type": "Answer",
...
const faqs = [
  {
    q: "How much does residential excavation cost in Charlotte?",
  ...
  {
    q: "How long does foundation excavation take for a new home in Charlotte?",
    a: "A standard residential foundation dig in the Charlotte area typically takes one to three days. The timeline depends on the size of the footprint, required depth, and how much clay or hardpan we encounter. Charlotte soils vary widely — some lots dig fast, others take longer. We give you a specific timeline with every written estimate.",
  },
  {
    q: "Do I need a permit for residential excavation in Charlotte?",
      ...
      <section className="relative py-28 md:py-40">
        ...
        <div className="relative max-w-[1200px] mx-auto px-6 text-center">
          ...
          <p className="text-white opacity-80 text-lg max-w-2xl mb-10 leading-relaxed mx-auto">
            Foundation digs, basement excavation, utility trenching, septic systems, and drainage work — handled right the first time. We serve Charlotte and surrounding communities with licensed, insured residential earthwork crews and free written estimates.
          </p>
        ...
        <div className="max-w-[800px] mx-auto px-6">
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="flex-1">
              <h2 className="text-2xl md:text-3xl font-extrabold mb-4" style={{ color: "#1B2A4A" }}>
                Reliable Residential Excavation Services for Your Home Projects in <span style={{ color: "#C4883A" }}>Charlotte</span>
              </h2>
            ...
            <div className="flex-1">
              <div className="relative w-full rounded-xl overflow-hidden" style={{ aspectRatio: "4/3" }}>
                <Image src={sectionImg} alt="Residential excavation project in Charlotte" fill loading="lazy" style={{ objectFit: "cover", objectPosition: "center" }} />
              </div>
            </div>
          </div>

          <h2 className="text-2xl md:text-3xl font-extrabold mb-6 mt-10" style={{ color: "#1B2A4A" }}>
            Why Choose Excavation Charlotte Co. for <span style={{ color: "#C4883A" }}>Residential Excavation?</span>
          </h2>
          ...
          <div className="space-y-3 mb-6">
            {[
              ...
              { title: "Experienced Team", desc: "With years of expertise in Northeast North Carolina soil conditions, we understand the unique challenges of residential projects." },
      ...
      <section className="py-20" style={{ backgroundColor: "#ffffff" }}>
        <div className="max-w-[1200px] mx-auto px-6 text-center">
          ...
          <p className="text-base mb-8 max-w-xl mx-auto" style={{ color: "#2D2D2D", opacity: 0.7 }}>
            We provide residential excavation services across Charlotte and surrounding areas.
          </p>
