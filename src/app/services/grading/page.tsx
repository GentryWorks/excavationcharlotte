...
import serviceImg from "@/assets/excavator-grading-charlotte.webp";
...
const faqSchema = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "How much does yard grading cost in Charlotte?",
      acceptedAnswer: {
        "@type": "Answer",
...
const faqs = [
  {
    q: "How much does yard grading cost in Charlotte?",
      ...
      <section className="relative py-28 md:py-40">
        ...
        <div className="relative max-w-[1200px] mx-auto px-6 text-center">
          ...
          <p className="text-white opacity-80 text-lg max-w-2xl mb-10 leading-relaxed mx-auto">
            We handle rough grading, finish grading, drainage correction, and building pad prep for residential and commercial sites across Charlotte and Northeast North Carolina.
          </p>
      ...
      <section className="py-20" style={{ backgroundColor: "#ffffff" }}>
        <div className="max-w-[800px] mx-auto px-6">
          <h2 className="text-2xl md:text-3xl font-extrabold mb-6" style={{ color: "#1B2A4A" }}>
            Expert Grading and Sitework Services in <span style={{ color: "#C4883A" }}>Charlotte</span> for Residential and Commercial Projects
          </h2>
      ...
      <section className="py-20" style={{ backgroundColor: "#ffffff" }}>
        <div className="max-w-[1200px] mx-auto px-6 text-center">
          ...
          <p className="text-base mb-8 max-w-xl mx-auto" style={{ color: "#2D2D2D", opacity: 0.7 }}>
            We provide grading and sitework services across Charlotte and surrounding areas.
          </p>
