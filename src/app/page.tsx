...
const faqSchema = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "Do I need a permit for excavation work in Charlotte?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Most excavation projects in Charlotte require a permit through the City of Charlotte Department of Construction and Inspections (SDCI). Demolition work requires its own permit as well. We guide you through what your specific project needs and handle demolition permits directly. For permits tied to a new build, we coordinate with your general contractor.",
      },
    },
    {
      "@type": "Question",
      name: "How do I find a reliable excavation contractor near me in Charlotte?",
      acceptedAnswer: {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      name: "How long does residential excavation take in Charlotte?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "A standard residential foundation dig typically takes one to three days depending on the size of the footprint and soil conditions. The Charlotte area's glacial till and clay-heavy soils can slow things down compared to sandier ground, especially during the rainy season. Land clearing or larger sitework projects run longer — usually three to seven days. We give you a realistic timeline with every estimate.",
      },
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      name: "Can you dig a pool in my backyard in Charlotte?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes. We handle inground pool excavation for concrete, fiberglass, and vinyl liner pools throughout the Greater Charlotte area. We coordinate directly with your pool builder, handle all soil hauling, and work within the access constraints of your yard. Before any dig, we verify underground utility locations through North Carolina 811.",
      },
    },
    {
      "@type": "Question",
      name: "Are you licensed and insured for excavation and demolition in North Carolina?",
      acceptedAnswer: {
        "@type": "Answer",
...
const faqs = [
  {
    q: "Do I need a permit for excavation work in Charlotte?",
    a: "Most excavation projects in Charlotte require a permit through the City of Charlotte Department of Construction and Inspections (SDCI). Demolition work requires its own permit as well. We guide you through what your specific project needs and handle demolition permits directly. For permits tied to a new build, we coordinate with your general contractor.",
  },
  {
    q: "How do I find a reliable excavation contractor near me in Charlotte?",
    a: "Look for a contractor who is licensed and carries general liability insurance — and will provide a certificate of insurance (COI) before work starts. Ask whether they own their own equipment or subcontract the work out. A contractor who owns and operates their own fleet has more control over your timeline and quality. Always get a written quote before any work begins.",
  },
  {
    q: "How long does residential excavation take in Charlotte?",
    a: "A standard residential foundation dig typically takes one to three days depending on the size of the footprint and soil conditions. The Charlotte area's glacial till and clay-heavy soils can slow things down compared to sandier ground, especially during the rainy season. Land clearing or larger sitework projects run longer — usually three to seven days. We give you a realistic timeline with every estimate.",
  },
  {
  ...
  {
    q: "Can you dig a pool in my backyard in Charlotte?",
    a: "Yes. We handle inground pool excavation for concrete, fiberglass, and vinyl liner pools throughout the Greater Charlotte area. We coordinate directly with your pool builder, handle all soil hauling, and work within the access constraints of your yard. Before any dig, we verify underground utility locations through North Carolina 811.",
  },
  {
    q: "Are you licensed and insured for excavation and demolition in North Carolina?",
  ...
  return (
    <>
      ...
      <section className="relative pt-36 pb-16 md:pt-44 md:pb-24">
        ...
        <Image
          src={heroImg}
          alt="Excavation skid steer working on a job site in Charlotte"
          fill
          fetchPriority="high"
          loading="eager"
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="flex flex-col md:flex-row gap-12 items-center">
            ...
            <div className="flex-shrink-0 w-full md:w-[520px] relative rounded-xl overflow-hidden" style={{ aspectRatio: "4/3" }}>
              <Image
                src={fleetImg}
                alt="Excavation fleet equipment lineup in Charlotte"
                fill
                loading="lazy"
                style={{ objectFit: "cover", objectPosition: "center" }}
              />
      ...
      <section className="py-20" style={{ backgroundColor: "#ffffff" }}>
        <div className="max-w-[1200px] mx-auto px-6">
          <h2
            ...
            style={{ color: "#1B2A4A" }}
          >
            Excavation Services in Charlotte, NC
          </h2>
          <p
          ...
          >
            ...
            projects across Charlotte and the Greater Lake Norman region.
          </p>
      ...
      <section className="py-20" style={{ backgroundColor: "#ffffff" }}>
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          <p
            ...
            style={{ color: "#2D2D2D", opacity: 0.7 }}
          >
            We work across Greater Charlotte and the Lake Norman region — from the city
