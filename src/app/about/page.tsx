...
import aboutImg from "@/assets/excavator-about-charlotte.webp";
...
const values = [
  ...
  {
    emoji: "📍",
    title: "Charlotte Local",
    description:
      "We work in the Greater Charlotte area every day. We know the soil conditions, permit requirements, and drainage challenges that come with building in this region.",
  },
  {
    emoji: "✅",
  ...
  return (
    <>
      ...
      <section className="relative py-28 md:py-40">
        ...
        <Image
          src={aboutImg}
          alt="Excavator on a job site in Charlotte"
          fill
          fetchPriority="high"
          loading="eager"
        ...
        <div className="relative max-w-[1200px] mx-auto px-6 text-center">
          <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-6">
            Your Charlotte <span style={{ color: "#C4883A" }}>Excavation Contractor</span>
          </h1>
          <p className="text-lg text-white opacity-90 max-w-xl mx-auto">
            Licensed excavation services for homeowners, builders, and developers across the Greater Charlotte area.
          </p>
        </div>
      </section>
      ...
      <section className="py-20" style={{ backgroundColor: "#ffffff" }}>
        <div className="max-w-[800px] mx-auto px-6">
          <h2
            ...
            style={{ color: "#1B2A4A" }}
          >
            An Excavation Company <span style={{ color: "#C4883A" }}>Charlotte Trusts</span>
          </h2>
          ...
          <p
            ...
            style={{ color: "#2D2D2D", opacity: 0.85 }}
          >
            We serve Charlotte and the surrounding communities including Bellevue, Redmond, Kirkland, Renton, Shoreline, Burien, Kent, Auburn, Federal Way, and Tacoma. We work with homeowners, custom home builders, general contractors, and developers across the greater Lake Norman region. If it involves moving earth in this area, we can help.
          </p>
        </div>
      </section>
