          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 items-start">
            ...
            <div className="lg:col-span-2 flex flex-col gap-6">
              ...
              <div className="rounded-xl overflow-hidden shadow-sm" style={{ height: "280px" }}>
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d171803.85038478!2d-122.47633315!3d47.6062095!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x5490102c93e83355%3A0x102565466944d59a!2sCharlotte%2C%20WA!5e0!3m2!1sen!2sus!4v1"
                  width="100%"
                  height="100%"
                  style={{ border: "none" }}
                  allowFullScreen
                  ...
                  title="Charlotte Excavation Co. service area map"
                />
              </div>
            </div>
